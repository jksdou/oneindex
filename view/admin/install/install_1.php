...
<div class="mdui-container-fluid">
	...
	<div class="mdui-typo">
		<h4 class="doc-article-title">
			...
			<a href="<?php echo $app_url; ?>" target="_blank" class="mdui-btn mdui-color-theme-accent mdui-ripple"><i class="mdui-icon material-icons">open_in_new</i> 获取应用ID和机密(分两个页面显示，请注意保存)</a>
		</h4>
	</div>
	...
	<form action="" method="post">
		...
		<div class="mdui-textfield mdui-textfield-floating-label">
			<i class="mdui-icon material-icons">rotate_right</i>
