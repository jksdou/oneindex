...
<div class="mdui-container-fluid">
    ...
    <?php if ($refresh_token) : ?>
        ...
        <br><br>
        <a class="mdui-btn mdui-color-theme-accent mdui-ripple mdui-float-left" href="?/admin/">
            <i class="mdui-icon material-icons">settings</i> 管理后台
        </a>(初始密码:oneindex)
        <a class="mdui-btn mdui-color-theme-accent mdui-ripple mdui-float-right" href="./">
            <i class="mdui-icon material-icons">folder</i> 访问网站
        </a>
    <?php else : ?>
