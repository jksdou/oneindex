            ...
            <ul class="mdui-list">
                ...
                <?php foreach ((array)$items as $item) : ?>
                    <?php if (!empty($item['folder'])) : ?>
                        ...
                        <li class="mdui-list-item mdui-ripple filter" data-sort data-sort-name="<?php echo $item['name']; ?>" data-sort-date="<?php echo $item['lastModifiedDateTime']; ?>" data-sort-size="<?php echo $item['size']; ?>" id="<?php echo $item["id"] ?>">
                    ...
                    <?php else : ?>
                        <li class="mdui-list-item file mdui-ripple filter" data-sort data-sort-name="<?php echo $item['name']; ?>" data-sort-date="<?php echo $item['lastModifiedDateTime']; ?>" data-sort-size="<?php echo $item['size']; ?>" id="<?php echo $item["id"] ?>">
                            <div class="simple-spinner loading-gif" style="display: none;"></div>
                            <?php if (is_login()) : ?>
                                <label class="mdui-checkbox">
                                    <input type="checkbox" value="<?php echo $item["id"] ?>" name="itemid" onclick="onClickHander()">
...
<div class="mdui-fab-wrapper" id="myFab">
    ...
    <div class="mdui-fab-dial">
        <button class="mdui-fab mdui-fab-mini mdui-ripple mdui-color-red" id="search" style="display: <?php if (!is_login()) echo "none"; else echo "inline" ?>;">
