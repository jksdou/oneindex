...
class onedrive
{
    ...
    {
        // 预览：https://graph.microsoft.com/v1.0/me/drive/items/01OODMPBAFUCGPG4SHFBCL7CKEDMNFMH54/preview
        $request = self::request($path, 'children?select=name,size,folder,createdDateTime,lastModifiedDateTime,id,@microsoft.graph.downloadUrl');
        $items = array();
